...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/front/participant.js">
</script>
</head>
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav " id="my-nav">
                ...
                <li class="active"><a href="participant">参与标的</a></li>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button  type="button" class="btn btn-primary" data-dismiss="modal" onClick="finshTrade()">
							确定
						</button>
					</div>
				</div><!-- /.modal-content -->
...
<div class="publish-sequence">
 <h3>我参与的交易记录</h3>   
 	<div id="toolbar">
      <button id="finish" class="btn btn-danger"   data-toggle="modal" data-target="#myModal" disabled>
          完成交易
      </button>
     </div>
